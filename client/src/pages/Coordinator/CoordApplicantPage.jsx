			...
			<aside className="left-sidebar" style={{ borderRadius: "8px" }}>
				<div className="sidebar-top">
					<div className="menu-item">
						...
						<span style={{ color: "#211e1e", fontWeight: "500" }}>Dashboard</span>
					</div>
					<div className="menu-item">
						<img src={Location} alt="Location Icon" />
						<span style={{ color: "#211e1e", fontWeight: "500" }}>Location</span>
					</div>
					<div className="menu-item">
						<img src={DatePosted} alt="Date Icon" style={{ backgroundColor: "grey" }} />
						<span style={{ color: "#211e1e", fontWeight: "500" }}>Date Posted</span>
					</div>
					<div className="menu-item">
						<img src={oldtonew} alt="Sort Icon" />
						<span style={{ color: "#211e1e", fontWeight: "500" }}>Oldest to Newest</span>
					</div>
					<div className="menu-item">
